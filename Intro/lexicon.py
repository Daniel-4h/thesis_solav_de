class Lexicon:
    ...
    consent_bullet3 = 'Sie werden gebeten, Ihre Einstellung zu verschiedenen politischen Vorschlägen anzugeben.'
    ...
    consent_p4 = 'Es sind keine bekannten Risiken im Zusammenhang mit Ihrer Teilnahme an dieser Forschung bekannt, die über die des täglichen Lebens hinausgehen. Ihre Teilnahme kann dazu beitragen, offene Forschungsfragen in der Verhaltens- und Umweltpsychologie besser zu verstehen. Eine Kompensation erfolgt nicht, Sie nehmen freiweillig an dieser Studie teil'

    privacy = 'Datenschutz:'
    consent_p5 = 'Die Vertraulichkeit Ihrer Daten wird zu jder Zeit streng beachtet. Die Daten können niemals direkt mit der individuellen Identität verknüpft werden. Niemand, einschließlich der Forschenden dieser Studie, wird in der Lage sein, Ihre Identität offenzulegen. Die Daten werden in anonymisierter Form auf Open-Science-Plattformen verfügbar gemacht. Alle sensiblen Informationen, die potenziell zur Offenlegung Ihrer Identität verwendet werden könnten, werden aus dem Datensatz entfernt, bevor die Daten veröffentlicht werden. Wir, die Forschenden des Projekts, werden auch niemals die Identität eines der Teilnehmer kennen, es sei denn, Sie offenbaren sie uns, indem Sie uns per E-Mail kontaktieren.'
    ...
    consent_p8 = 'Wenn Ihnen etwas an der Studie oder Ihrer Teilnahme unklar ist, wenn Sie Fragen haben oder ein forschungsbezogenes Problem melden möchten, senden Sie eine E-Mail an daniel.ahrndsen@unibas.ch'
